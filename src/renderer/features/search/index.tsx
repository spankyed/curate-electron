...
import ThumbPapersGrid from '@renderer/features/date-entry/components/grid';
import PapersTable from '@renderer/features/date-entry/components/table';
...
import { updatePaperInListAtom } from '@renderer/core/store';
...
const PageMessage: React.FC<PageMessageProps> = ({ message }) => {
  return (
...
const Results: React.FC<ResultsProps> = ({ isLoading = false }) => {
