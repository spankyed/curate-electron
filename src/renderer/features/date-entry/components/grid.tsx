...
import { PlaceholderList } from '@renderer/features/calendar/components/placeholder';
import PaperTile from '@renderer/core/components/common/paper/tile';
...
}> = ({ papers, isLoading = false, placeholderRows = 4 }) => {
