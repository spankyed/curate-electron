...
const storagePath = path.join(dirname, '../../services/database/sqlite/curate.db');
...
class PapersTable extends Model {
  declare id: string;
  declare date: string;
...
class DatesTable extends Model {
  declare value: string;
  declare status: string;
  declare count: number;
}

class ReferencePapersTable extends Model {
  declare id: string;
  // declare chroma_id: string;
}

class ThreadsTable extends Model {
  declare id: string;
...
class MessagesTable extends Model {
  declare id: string;
...
class PdfDocumentTable extends Model {
  declare id: string;
  declare paperId: string;
...
// const PaperVideosTable = sequelize.define('PaperVideosTable', {
//   id: {
//     type: DataTypes.INTEGER,
//     primaryKey: true,
//     autoIncrement: true
